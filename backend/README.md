...
## Project Structure
    ...
    ├── removeconnectortagtest_1  # Django project configurations
...
1. Clone this repo and `cd removeconnectortagtest_1`
...
2. Clone this repo and `cd removeconnectortagtest_1`
