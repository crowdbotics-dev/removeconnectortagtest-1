"""
Django settings for removeconnectortagtest_1 project.
...
ROOT_URLCONF = 'removeconnectortagtest_1.urls'
...
WSGI_APPLICATION = 'removeconnectortagtest_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "removeconnectortagtest_1 API",
    "DESCRIPTION": "API documentation for removeconnectortagtest_1 App",
    "VERSION": "v1",
}
